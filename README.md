...
Основная цель программы — избавить пользователя от необходимости работать с командной строкой и терминалом, вручную редактировать конфигурационные файлы `.cnf`, а для пользователей Windows — устанавливать дополнительное ПО (OpenSSL).
